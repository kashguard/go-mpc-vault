...
type UserCredential struct {
	...
	CredentialID    string      `boil:"credential_id" json:"credential_id" toml:"credential_id" yaml:"credential_id"`
	...
	Aaguid          null.String `boil:"aaguid" json:"aaguid,omitempty" toml:"aaguid" yaml:"aaguid,omitempty"`
	SignCount       null.Int    `boil:"sign_count" json:"sign_count,omitempty" toml:"sign_count" yaml:"sign_count,omitempty"`
...
var UserCredentialTableColumns = struct {
	...
	CredentialID:    "user_credentials.credential_id",
	PublicKey:       "user_credentials.public_key",
	AttestationType: "user_credentials.attestation_type",
	Aaguid:          "user_credentials.aaguid",
	SignCount:       "user_credentials.sign_count",
	DeviceName:      "user_credentials.device_name",
	LastUsedAt:      "user_credentials.last_used_at",
...
var UserCredentialWhere = struct {
	...
	CredentialID    whereHelperstring
	PublicKey       whereHelperstring
	AttestationType whereHelpernull_String
	Aaguid          whereHelpernull_String
	SignCount       whereHelpernull_Int
	DeviceName      whereHelpernull_String
	LastUsedAt      whereHelpernull_Time
	CreatedAt       whereHelpernull_Time
	UpdatedAt       whereHelpernull_Time
}{
	ID:              whereHelperstring{field: "\"user_credentials\".\"id\""},
	UserID:          whereHelperstring{field: "\"user_credentials\".\"user_id\""},
	CredentialID:    whereHelperstring{field: "\"user_credentials\".\"credential_id\""},
	PublicKey:       whereHelperstring{field: "\"user_credentials\".\"public_key\""},
	AttestationType: whereHelpernull_String{field: "\"user_credentials\".\"attestation_type\""},
	Aaguid:          whereHelpernull_String{field: "\"user_credentials\".\"aaguid\""},
	SignCount:       whereHelpernull_Int{field: "\"user_credentials\".\"sign_count\""},
	DeviceName:      whereHelpernull_String{field: "\"user_credentials\".\"device_name\""},
	LastUsedAt:      whereHelpernull_Time{field: "\"user_credentials\".\"last_used_at\""},
	CreatedAt:       whereHelpernull_Time{field: "\"user_credentials\".\"created_at\""},
	UpdatedAt:       whereHelpernull_Time{field: "\"user_credentials\".\"updated_at\""},
}
...
func (o *UserCredential) GetUser() *User {
	if o == nil {
		return nil
	}
...
func (r *userCredentialR) GetUser() *User {
	if r == nil {
		return nil
	}
...
var (
	userCredentialAllColumns            = []string{"id", "user_id", "credential_id", "public_key", "attestation_type", "aaguid", "sign_count", "device_name", "last_used_at", "created_at", "updated_at"}
	userCredentialColumnsWithoutDefault = []string{"user_id", "credential_id", "public_key"}
	userCredentialColumnsWithDefault    = []string{"id", "attestation_type", "aaguid", "sign_count", "device_name", "last_used_at", "created_at", "updated_at"}
...
func (o *UserCredential) User(mods ...qm.QueryMod) userQuery {
...
func (userCredentialL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserCredential interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		foreign.R.UserCredentials = append(foreign.R.UserCredentials, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.UserID == foreign.ID {
				...
				foreign.R.UserCredentials = append(foreign.R.UserCredentials, local)
				break
			}
		}
	}
...
// SetUser of the userCredential to the related item.
// Sets o.R.User to related.
// Adds o to related.R.UserCredentials.
func (o *UserCredential) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			UserCredentials: UserCredentialSlice{o},
		}
	} else {
		related.R.UserCredentials = append(related.R.UserCredentials, o)
	}
...
func FindUserCredential(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*UserCredential, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"user_credentials\" where \"id\"=$1", sel,
	)
...
func (o *UserCredential) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"user_credentials\" WHERE \"id\"=$1"
...
func UserCredentialExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"user_credentials\" where \"id\"=$1 limit 1)"
...
func (o *UserCredential) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserCredentialExists(ctx, exec, o.ID)
}
